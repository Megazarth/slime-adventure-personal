...
namespace Slime
{
	public class CustomJoystick : MonoBehaviour, IPointerDownHandler, IDragHandler, IPointerUpHandler
	{
		...
		{
			rectInputField.anchorMin = this.anchorMin;
			rectInputField.anchorMax = this.anchorMax;
		}

		public void SetAnchorForMultiplayer()
		{
			var cuurrentAnchorMin = rectInputField.anchorMin;
			cuurrentAnchorMin.x = 0f;
			rectInputField.anchorMin = cuurrentAnchorMin;

			var currentAnchorMax = rectInputField.anchorMax;
			currentAnchorMax.x = 1f;
			rectInputField.anchorMax = currentAnchorMax;
		}
	}
}